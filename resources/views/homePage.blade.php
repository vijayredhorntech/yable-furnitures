          ...
          <div class="absolute top-0 left-0 w-full h-full flex  bg-black/50">
              <div class="h-max w-max text-white flex  flex-col my-auto px-8 ">
                  ...
                  <div class="mt-4">
                      ...
                      <button class=" text-white  border-[1px] border-black lg:px-6 md:px-6 sm:px-6 px-3 py-2 font-semibold hover:bg-black hover:text-white transition ease-in duration-200 hover:font-bold lg:text-xl md:text-xl sm:text-xl text-lg lg:mt-0 md:mt-0 sm:mt-0 mt-2 ">SUBSCRIBE</button>
                  </div>
              </div>
          </div>
         </div>
